...
const Navbar = () => {
    ...
    const links = <>
        ...
        <NavLink className="btn btn-ghost" to="/statistics">Statistics</NavLink>
        <NavLink className="btn btn-ghost" to="/applied">Applied Jobs</NavLink>
        <NavLink className="btn btn-ghost" to="/blog">Blogs</NavLink>
    </>
